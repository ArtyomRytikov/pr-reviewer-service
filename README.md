...
### Запуск
Запускается с помощью команд "docker-compose up --build" - сборка + запуск или "make docker-up" либо же сначала производим сборку "docker-compose up build" и потом запускаем "docker-compose up"
